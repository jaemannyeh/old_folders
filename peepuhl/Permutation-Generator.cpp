// https://jg.gg/permutation-generator-coding-interview-question/
// c++ -std=c++11 Permutation-Generator.cpp
...
int main() {
  ...
  while (true) {
    ...
    PermutationGenerator p { n }; // PermutationGenerator p ( n );
    int count = 0;
    while (true) {
      vector<int> result = p();
      if (result.empty()) {
