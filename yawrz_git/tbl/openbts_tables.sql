...
INSERT OR IGNORE INTO "CONFIG" VALUES('CLI.Interface','127.0.0.1',0,0,'Interface for use in communicating between CLI and OpenBTS, use "any" for all interfaces, otherwise, a comma separated list of interfaces');
INSERT OR IGNORE INTO "CONFIG" VALUES('CLI.Port','49300',0,0,'Port number (tcp/udp) for use in communicating between CLI and OpenBTS');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('Core.File','core.openbts',0,0,'Constant part of core file name to use (excluding optional pid)');
INSERT OR IGNORE INTO "CONFIG" VALUES('Core.Pid','0',0,0,'1=enabled, 0=disabled - 1 to add a .pid number to the end of the filename');
INSERT OR IGNORE INTO "CONFIG" VALUES('Core.SaveFiles','1',0,0,'1=enabled, 0=disabled - 1 to save system files in a tarball for post-mortem analysis');
INSERT OR IGNORE INTO "CONFIG" VALUES('Core.TarFile','/tmp/openbtsfiles.tgz',0,0,'Name of filename to save /proc files for post-mortem analysis after a crash');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.BTS.RADIO_LINK_TIMEOUT','15',1,0,'Number of failed SACCH reports before the BTS declares a physical link dead.  GSM 5.08 5.2 and 5.3.  SACCH reports are at 480ms intervals.  Similar to GSM.CellOptions.RADIO-LINK-TIMEOUT which serves the same purpose in the MS.    Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.CCCH.BS_AG_BLKS_RES','auto',1,0,'CCCH paging configuration: number of CCCH blocks reserved for AGCH.  Defined in GSM 5.02 3.3.2.3.  Value auto means OpenBTS picks a reasonable value, otherwise range is 0..2 for a Combination-V beacon or 0..7 for a Combination-IV beacon.  Only super-experts should set this to any value other than auto.    Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.CCCH.BS_PA_MFRMS','2',1,0,'CCCH paging configuration: number of Paging Multiframes.  Defined in GSM 5.02 3.3.2.3.  Only super-experts should change this.    Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.CCCH.CCCH-CONF','1',1,0,'CCCH configuration type.  Defined in GSM 5.02 3.3.2.3.  DO NOT CHANGE THIS.  Value is fixed by the implementation.    Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.CellOptions.RADIO-LINK-TIMEOUT','15',1,0,'Number of failed SACCH reports before an MS declares a physical link dead.  GSM 5.08 5.2.  SACCH reports are at 480ms intervals.  This value, converted to seconds, should be less than GSM.Timer.T3109.   Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Channels.NumC1s','auto',1,0,'Number of Combination-I timeslots to configure.  The Combination-1 timeslot carries a single full-rate TCH, used for speech calling.  If value is auto, OpenBTS picks the value by using all otherwise unused timeslots.    Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Channels.NumC7s','auto',1,0,'Number of Combination-VII timeslots to configure.  The Combination-7 timeslot carries 8 SDCCHs, useful to handle high registration loads or SMS.  If value is auto, OpenBTS picks the value based on beacon type and number of ARFCNs.    Static.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.FailureHoldoff','20',0,0,'The number of seconds to wait before attempting another handover with a given neighbor BTS.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.History.Max','32',0,0,'Maximum neighbor history to consider for handover.  Units are number of measurement reports, which occur once each 480ms.  ');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.Margin','15',1,0,'Unconditional handover if RXDIFF exceeds this margin.  The GSM.Handover.RXLEV_DL.PenaltyTime will prevent reverse handovers for that period.    Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.Ny1','50',1,0,'Maximum number of repeats of the Physical Information Message during handover procedure, GSM 04.08 11.1.3.  Static.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.RXLEV_DL.History','6',0,0,'The number of 480ms periods to consider for this handover criteria.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.RXLEV_DL.Margin','10',0,0,'RXLEV_DL is reported by the MS for the serving cell and each neighbor cell.  Handover attempted if the serving cell RXLEV_DL < GSM.Handover.RXLEV_DL.Target and RXDIFF > GSM.Handover.RXLEV_DL.Margin');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.RXLEV_DL.PenaltyTime','20',0,0,'After a handover a reverse handover to the originating BTS is prevented for this period of time in seconds. ');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Handover.RXLEV_DL.Target','60',0,0,'RXLEV_DL is reported by the MS for the serving cell and each neighbor cell.  Handover attempted if the serving cell RXLEV_DL < GSM.Handover.RXLEV_DL.Target and RXDIFF > GSM.Handover.RXLEV_DL.Margin');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.MS.Power.Damping','75',0,0,'Damping value for MS power control loop in percent.  The ordered MS power is based on RSSI [Received Signal Strength Indication].  A value of 100 here ignores RSSI and SNR entirely;  a value of 0 causes the MS power to change instantaneously based on RSSI or SNR, which is inadvisable because it sets up power oscillations.  The ordered MS power is then clamped between GSM.MS.Power.Max and GSM.MS.Power.Min.  ');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.MS.TA.Damping','50',0,0,'Damping value for TA [timing advance] control loop, which specifies the TA to be applied by the MS.  This damping factor is meant to prevent a single bad incoming TA estimate from moving the TA value out of range.  ');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.RACH.TxInteger','14',0,0,'Parameter to spread RACH busts over time.  Warning: changing this parameter may cause intermittent channel acquisition failures.  This is the raw parameter sent on the BCCH used to determine the S (delay) and T (spread) parameters.  In the description for S: the first value is for beacon CCCH-CONF type 0,2,4 or 6 (non-combined CCCH) and the second value is for beacon CCCH-CONF type 1 (combined CCCH+SDCCH.)  See GSM 04.08 10.5.2.29 and 3.3.1.1.2 for encoding; 05.02 clause 7 table 3 and 5 for definition of a RACH slot.');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Timer.T3103','12000',0,0,'Handover timeout in milliseconds, GSM 04.08 11.1.2.  This is the timeout for a handset to seize a channel during handover.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Timer.T3105','50',0,0,'Milliseconds for handset to respond to physical information.  GSM 04.08 11.1.2.');
INSERT OR IGNORE INTO "CONFIG" VALUES('GSM.Timer.T3109','30000',0,0,'When a channel is released or contact with a handset is lost, the channel is deactivated for this period of time before being reused.  This time must be longer than the time indicated by GSM.CellOptions.RADIO-LINK-TIMEOUT.  GSM 04.08 11.1.2.  ');
...
INSERT OR IGNORE INTO "CONFIG" VALUES('SIP.Realm','',0,0,'SIP Realm for interop with certain switches. Filling in a host here will also activate an new REGISTER auth method.');
