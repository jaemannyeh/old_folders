...
#if 0
observer5.cpp:85:20: error: taking address of temporary [-fpermissive]
   ss.attach(&Gates());
                    ^
g++ -fpermissive observer5.cpp
observer5.cpp:85:20: warning: taking address of temporary [-fpermissive]
   ss.attach(&Gates());
                    ^
#endif
