...
public:
	...
	bool IsWhitespace(int n=0)		{return Scanner(n,1) && Character::IsWhitespace(*At(n,1));}
	bool IsAlphanumeric(int n=0)	{return Scanner(n,1) && Character::IsAlphanumeric(*At(n,1));}
	bool IsAlpha(int n=0)			{return Scanner(n,1) && Character::IsAlpha(*At(n,1));}
	bool IsHex(int n=0)				{return Scanner(n,1) && Character::IsHex(*At(n,1));}
	bool IsNumeric(int n=0)			{return Scanner(n,1) && Character::IsNumeric(*At(n,1));}
	bool IsDigit(int n=0)			{return Scanner(n,1) && Character::IsNumeric(*At(n,1));}
	bool IsAscii(int n=0)			{return Scanner(n,1) && Character::IsAscii(*At(n,1));}
	bool IsControl(int n=0)			{return Scanner(n,1) && Character::IsControl(*At(n,1));}
	bool IsPrintable(int n=0)		{return Scanner(n,1) && Character::IsPrintable(*At(n,1));}
	bool IsIdentifier(int n=0)		{return Scanner(n,1) && Character::IsIdentifier(*At(n,1));}
	bool IsPunctuation(int n=0)		{return Scanner(n,1) && Character::IsPunctuation(*At(n,1));}
	bool IsSymbol(int n=0)			{return Scanner(n,1) && Character::IsSymbol(*At(n,1));}
	bool IsDelimiter(int n=0)		{return Scanner(n,1) && Character::IsDelimiter(*At(n,1));}
	bool IsUppercase(int n=0)		{return Scanner(n,1) && Character::IsUppercase(*At(n,1));}
	bool IsLowercase(int n=0)		{return Scanner(n,1) && Character::IsLowercase(*At(n,1));}
	bool IsNewline(int n=0)			{return Scanner(n,1) && Character::IsNewline(*At(n,1));}
	...
	{		
		return Scanner(n,size) && SequenceLibrary::EqualsCaseless(At(n,size),data,size);
	}
	...
	bool Is(char data)			{return Scanner() && CharacterLibrary::Equals(*At(),data);}
	bool IsCaseless(char data)	{return Scanner() && CharacterLibrary::EqualsCaseless(*At(),data);}
	...
	{
		return Scanner(size) && SequenceLibrary::Equals(At(size),data,size);
	}
	...
	{	
		return Scanner(size) && SequenceLibrary::EqualsCaseless(At(size),data,size);
	}
	...
	bool IsAnyCaseless(char *tokens, int length)	
	{
		...
		{
			for (int i=0;i<length;++i)
				if (CharacterLibrary::EqualsCaseless(*At(),tokens[i])) return true;
		}
		return false;
	}
	...
	bool Parse(char *data, int size) {return Is(data,size) && Mark() && Scanner.Next(size) && Trap();}	
	bool Parse(const char data) {return Is(data) && Mark() && Next() && Trap();}
