...
public:
	...
	template<typename _Class_>
	_Return_ operator() (_Class_ * that, _Arg1_ arg1, _Arg2_ arg2, _Arg3_ arg3, _Arg4_ arg4, _Arg5_ arg5)
	{
		OutputAssert(Type != 0);
		OutputAssert(Type != CALL_TYPE_FUNCTION && that != 0);
...
public:
	...
	template<typename _Class_>
	_Return_ operator() (_Class_ * that)
	{
		OutputAssert(Type != 0);
		OutputAssert(Type != CALL_TYPE_FUNCTION && that != 0);
...
public:
	...
	template<typename _Class_>
	_Return_ operator() (_Class_ * that, _Arg1_ arg1)
	{
		OutputAssert(Type != 0);
		OutputAssert(Type != CALL_TYPE_FUNCTION && that != 0);
...
public:
	...
	template<typename _Class_>
	_Return_ operator() (_Class_ * that, _Arg1_ arg1, _Arg2_ arg2)
	{
		OutputAssert(Type != 0);
		OutputAssert(Type != CALL_TYPE_FUNCTION && that != 0);
...
public:
	...
	template<typename _Class_>
	_Return_ operator() (_Class_ * that, _Arg1_ arg1, _Arg2_ arg2, _Arg3_ arg3)
	{
		OutputAssert(Type != 0);
		OutputAssert(Type != CALL_TYPE_FUNCTION && that != 0);
...
public:
	...
	template<typename _Class_>
	_Return_ operator() (_Class_ * that, _Arg1_ arg1, _Arg2_ arg2, _Arg3_ arg3, _Arg4_ arg4)
	{
		OutputAssert(Type != 0);
		OutputAssert(Type != CALL_TYPE_FUNCTION && that != 0);
